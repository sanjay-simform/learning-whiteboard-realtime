  ...
  return (
    <Card className="w-full sm:max-w-md">
      <CardHeader className="my-5 text-center">
        <div className="logo mb-4 flex items-center justify-center">
          <svg
            id="Logo"
            viewBox="0 0 40 40"
        ...
        <CardTitle className="text-lg">Signin to Whiteboard Realtime</CardTitle>
        <CardDescription>
      ...
      <CardContent>
        {/* {error && (
          <div className="bg-semantic-danger bg-opacity-10 border-semantic-danger border-opacity-30 rounded-chat text-semantic-danger my-5 rounded border px-4 py-3 text-sm text-red-500">
            {error}
          </div>
        )} */}
